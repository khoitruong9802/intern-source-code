...
const AirportCreateForm = ({ open, setOpen, setRerender }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await createAirport(airportData);
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-6 text-center">New Airport</h2>
...
export default AirportCreateForm;
